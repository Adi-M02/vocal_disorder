...
from test_ngram_generation import load_phrasers_from_dir, apply_ngrams
from utils.stopwords import STOPWORDS

def process_text(text, stoplist = True, lemmatize = True, lookup_path='combined_lemmas.json'):
    """
